    ...
    <div className="min-h-screen w-full flex bg-brandBg overflow-hidden">
      ...
      <div className="hidden lg:flex lg:w-[58%] relative flex-col justify-between p-14 overflow-hidden border-r border-borderColor bg-white">
        ...
        <div className="absolute inset-0 z-0 overflow-hidden">
          <div className="absolute -top-24 -left-24 w-72 h-72 rounded-full bg-red-100 opacity-60 blur-3xl" />
          <div className="absolute bottom-0 right-0 w-80 h-80 rounded-full bg-pink-50 opacity-80 blur-3xl" />
        </div>
        ...
        <div className="relative z-10 my-auto max-w-lg space-y-8">
          <div className="space-y-4">
            ...
            <p className="text-textSecondary text-base leading-relaxed">
              Real-time inventory, zero guesswork. Gain absolute clarity over stock levels, sales trends, and supplier workflows.
            </p>
          </div>
      ...
      <div className="w-full lg:w-[42%] flex items-center justify-center p-6 md:p-12 relative">
        ...
        <div className="w-full max-w-sm">
          ...
          {error && (
            <div className="flex items-start space-x-2.5 p-3.5 rounded-xl border border-red-200 bg-red-50 text-brandPrimary text-xs font-semibold mb-5">
          ...
          <button
            ...
            className="w-full h-10 flex items-center justify-center space-x-3 rounded-xl border border-borderColor bg-white hover:bg-gray-50 text-textPrimary text-sm font-semibold transition-all active:scale-[0.98]"
          >
          ...
          <form onSubmit={handleSignIn} className="space-y-4">
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase tracking-wider text-textMuted">Email Address</label>
            ...
            <div className="space-y-1.5">
              <label className="text-[11px] font-bold uppercase tracking-wider text-textMuted">Password</label>
              <div className="relative">
            ...
            <Button type="submit" variant="default" className="w-full btn-primary-glow" disabled={loading}>
